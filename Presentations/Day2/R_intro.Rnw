...
\begin{frame}
	...
	\item Plot \tiny \url{https://figshare.com/articles/Slovenia_s_Gross_Domestic_Expenditure_on_R_amp_D_By_Sector_and_Field_2007_2013_/1564745}
		\normalsize
		\item Report \tiny \url{https://www.bioconductor.org/packages/release/bioc/vignettes/MSnbase/inst/doc/MSnbase-demo.pdf}
		\normalsize
		\item Flexdashboard \tiny \url{https://beta.rstudioconnect.com/llaire/htmlwidgets-ggplotly-geoms/htmlwidgets-ggplotly-geoms.html\#geom_point}
		\normalsize
...
\begin{frame}
	...
	\centering \includegraphics[scale=1.4]{../Day1/figures/folder_str.png}
\end{frame}
...
\pause
		\item patients[1] \pause  {\scriptsize \# first column in the data frame (as a data.frame)}
	\end{itemize}
\rule{\textwidth}{0.4pt}
